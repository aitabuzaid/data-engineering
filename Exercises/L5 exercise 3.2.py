...
create_yongest_task = PostgresOperator(
...
log_yongest_task = PythonOperator(
    task_id="log_yongest",
    dag=dag,
    python_callable=log_yongest
)

create_bike_rides = PostgresOperator(
...
create_station_counts = PostgresOperator(
    task_id="create_station_counts",
    dag=dag,
    sql="""
        BEGIN;
...
create_yongest_task >> log_yongest_task
